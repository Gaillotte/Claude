...
def generate(output_path: str):
    ...
    summary = [
        ...
        ("Transport",          4,  4,  "100% (mock)"),
        ("Security / TLS",     3,  3,  "100% (config)"),
    ...
    REQS = [
        ...
        ("REQ-021", "Profile Download", "SGP.32 §3.3.2",
         ...
         "IpadTest.ProfileDownloadConfirmationCode\nTV-DL-006",
         "VERIFIED"),
        ...
        ("REQ-024", "Profile Download", "SGP.32 §3.3.5",
         ...
         "IpadTest.ProfileDownloadAutoEnable\nTV-DL-002\nTC_WF_03",
         "VERIFIED"),
        ...
        ("REQ-033", "Profile Management", "SGP.32 §3.4.2",
         ...
         "src/ipad.cpp — enforced by TelSDK setProfile; verified by integration test",
        ...
        ("REQ-050", "Security", "SGP.32 §5.1",
         ...
         "IpadInitTest.TlsConfig (config level)",
         "VERIFIED"),
        ...
        ("REQ-051", "Security", "SGP.32 §5.2",
         ...
         "IpadInitTest.MutualTLS (config level)",
         "VERIFIED"),
        ...
        ("REQ-052", "Security", "SGP.32 §5.3",
         ...
         "IpadInitTest.PeerVerify (config level)",
         "VERIFIED"),
        ...
        ("REQ-061", "Event System", "SGP.32 §6.1",
         ...
         "TC_WF_03_EventDrivenDownload\nIpadTest.EventProfileEnabled\nIpadTest.EventProfileDeleted",
         "VERIFIED"),
        ...
        ("REQ-063", "Event System", "SGP.32 §6",
         ...
         "TC_WF_03 (multi-subscriber)\nIpadTest.EventMultipleSubscribers",
         "VERIFIED"),
        ...
        ("REQ-071", "Error Handling", "SGP.32 §7.1",
         ...
         "IpadInitTest.DefaultRetryCount\nTC_WF_04_RecoveryAfterFailure",
         "VERIFIED"),
        ...
        ("REQ-072", "Error Handling", "SGP.32 §7.2",
         ...
         "IpadTest.ProfileDownloadTimeout\nTV-DL-005\nTV-INIT-002",
         "VERIFIED"),
        ...
        ("REQ-081", "Diagnostics", "SGP.32 §8.1",
         ...
         "IpadLogTest.LogLevelFiltering\nIpadLogTest.LogLevelNone\nBenchSuite.LogSetHandler",
         "VERIFIED"),
        ...
        ("REQ-082", "Diagnostics", "SGP.32 §8.2",
         ...
         "IpadLogTest.CustomHandler\nIpadLogTest.HandlerRemoval",
         "VERIFIED"),
    ]
    ...
    xref = [
        ("Unit Tests (ipad_unit_tests)", [
            ("IpadInitTest.*",               ["REQ-001", "REQ-002", "REQ-071", "REQ-072"]),
            ("IpadVersionTest.*",            ["REQ-004"]),
            ("IpadTest.GetEid",              ["REQ-010"]),
            ("IpadTest.GetEuiccInfo",        ["REQ-011"]),
            ("IpadTest.ProfileList*",        ["REQ-030"]),
            ("IpadTest.ProfileGet",          ["REQ-031"]),
            ("IpadTest.ProfileDownloadSync", ["REQ-020"]),
            ("IpadTest.ProfileDownloadConfirmationCode", ["REQ-021"]),
            ("IpadTest.ProfileDownloadAsync",["REQ-022"]),
            ("IpadTest.ProfileDownloadAutoEnable", ["REQ-024"]),
            ("IpadTest.ProfileDownloadTimeout", ["REQ-072"]),
            ("IpadTest.ProfileEnable",       ["REQ-032"]),
            ("IpadTest.ProfileDisable",      ["REQ-034"]),
            ("IpadTest.ProfileDelete",       ["REQ-035"]),
            ("IpadTest.SetNickname",         ["REQ-036"]),
            ("IpadTest.ProfileGetState",     ["REQ-037"]),
            ("IpadTest.EventSubscribe*",     ["REQ-060"]),
            ("IpadTest.EventPump",           ["REQ-064"]),
            ("IpadTest.DiagExportJson",      ["REQ-080"]),
            ("IpadTest.Configure",           ["REQ-003"]),
            ("IpadTest.Selftest",            ["REQ-005"]),
            ("IpadUtilTest.Strerror",        ["REQ-070"]),
        ]),
        ("Log Tests (ipad_log_tests)", [
            ("IpadLogTest.LogLevelFiltering", ["REQ-081"]),
            ("IpadLogTest.LogLevelNone",      ["REQ-081"]),
            ("IpadLogTest.CustomHandler",     ["REQ-082"]),
            ("IpadLogTest.HandlerRemoval",    ["REQ-082"]),
        ]),
        ("Integration Tests (ipad_integration_tests)", [
            ("TC_WF_01 — Full Lifecycle",          ["REQ-001", "REQ-020", "REQ-032", "REQ-034", "REQ-035", "REQ-037"]),
            ("TC_WF_02 — Multiple Profiles",       ["REQ-030", "REQ-033"]),
            ("TC_WF_03 — Event-driven Download",   ["REQ-023", "REQ-024", "REQ-061", "REQ-063"]),
            ("TC_WF_04 — Recovery After Failure",  ["REQ-071"]),
            ("TC_WF_05 — Concurrent Operations",   ["REQ-030"]),
            ("TC_WF_06 — Nickname Persistence",    ["REQ-036"]),
            ("TC_WF_07 — Diagnostic After Changes",["REQ-080"]),
        ]),
        ("SGP.32 Vector Runner (ipad_vector_runner)", [
            ("TV-INIT-001..003", ["REQ-001", "REQ-002", "REQ-072"]),
            ("TV-EID-001..002",  ["REQ-010"]),
            ("TV-LST-001..005",  ["REQ-030", "REQ-031", "REQ-037"]),
            ("TV-DL-001..007",   ["REQ-020", "REQ-021", "REQ-022", "REQ-024", "REQ-072"]),
            ("TV-EN-001..003",   ["REQ-032", "REQ-033"]),
            ("TV-DIS-001",       ["REQ-034"]),
            ("TV-DEL-001..002",  ["REQ-035"]),
            ("TV-NICK-001..002", ["REQ-036"]),
            ("TV-EVT-001..003",  ["REQ-060"]),
            ("TV-DIAG-001..002", ["REQ-080"]),
            ("TV-UTIL-001..016", ["REQ-070"]),
        ]),
        ("Benchmarks (ipad_bench)", [
            ("BenchSuite.GetEid",                ["REQ-010"]),
            ("BenchSuite.GetEuiccInfo",          ["REQ-011"]),
            ("BenchSuite.ProfileListEmpty/Eight", ["REQ-030"]),
